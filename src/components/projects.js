                            ...
                            <Col xs={12} md={6}>
                                    <div className="project">
                                        ...
                                        <div className="project-description">
                                            <p>C4 Bot is a Python AI bot that autonomously plays the game, <a href="https://papergames.io/en/connect4">Connect Four, online</a>.</p>
